...
// @ts-ignore
import IMG_SnickerDoodleCookie from '../images/SD-Stack_1280x.png';
// @ts-ignore
        ...
        <div className="widget-container">
            <div className="widget-row">
                <div className="widget-item large-rectangle">
                    Yearly Sales By Month Line Chart
                </div>
            </div>
            ...
            <div className="widget-row">
                <div className="widget-item small-rectangle">
                    ...
                    <div className="widget-side-info">
                        ...
                        <h4 className="text-green">+$7,724</h4>
                    </div>
                    <hr/>
                </div>
                ...
                <div className="widget-item small-rectangle">
                    ...
                    <div className="widget-side-info">
                        <h3>Todays Sales</h3>
                        <h4 className="text-green">+2484</h4>
                    </div>
                    <hr/>
                </div>
                ...
                <div className="widget-item small-rectangle">
                    ...
                    <div className="widget-side-info">
                        ...
                        <h4 className="text-blue">$273,509</h4>
                    </div>
                    <hr/>
                </div>
                ...
                <div className="widget-item small-rectangle">
                    ...
                    <div className="widget-side-info">
                        ...
                        <h4 className="text-blue">187,495</h4>
                    </div>
                    <hr/>
                </div>
            ...
            <div className="widget-row">
                <div className="widget-item medium-square">
                    Most popular products top 3 today
